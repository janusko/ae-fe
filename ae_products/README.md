* Your given an HTML files containing divs representing AlgoExpert's products. Using only CSS, aling the products in three rows following these specifications:
